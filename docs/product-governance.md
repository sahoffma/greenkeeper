...
Dieses Dokument regelt **Ebene 1 – Produktkatalog** (globale Produktdaten). Persönliche Gebinde, Bestandsbewegungen und die Kopplung zur Journal-Düngung sind **nicht** Teil des Governance-Schreibpfads; sie folgen [GM-008](./model/gm-008.md), [GA-012](./architecture/ga-012.md), [DL-019](./decisions/dl-019.md), [DL-020](./decisions/dl-020.md) und [DL-021](./decisions/dl-021.md).
