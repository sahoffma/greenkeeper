...
**KI-Produkterkennung (GA-013):** Erkannte Produkte werden als **persönlicher Recognition Candidate** übernommen — **ohne** automatischen Eintrag in den offiziellen Katalog. Ein eindeutiger Greenkeeper-Katalogtreffer verwendet das bestehende Produkt; parallele persönliche Kandidaten entstehen dann nicht. **Product Enrichment** ([GA-014](./architecture/ga-014.md)) baut Produktwissen nach Identität auf; sichtbare Bestandsaufnahme erst nach objektartspezifischer Readiness-Prüfung — für Dünger verbindlich in [GM-009](./model/gm-009.md). Offizielle Katalogschreibungen bleiben über diesen Governance-Pfad.
