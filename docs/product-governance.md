...
Dieses Dokument regelt **Ebene 1 – Produktkatalog** (globale Produktdaten). Persönliche Gebinde, Bestandsbewegungen und die Kopplung zur Journal-Düngung sind **nicht** Teil des Governance-Schreibpfads; sie folgen [GM-008](./model/gm-008.md), [GA-012](./architecture/ga-012.md), [DL-019](./decisions/dl-019.md) bis [DL-029](./decisions/dl-029.md). Ein gespeichertes Product Profile erzeugt **keinen** automatischen persönlichen Bestand — Inventory Items entstehen ausschließlich durch explizite Nutzeraktion ([DL-026](./decisions/dl-026.md)); mengenbasierte Angaben erfordern **Gebindeauflösung mit Nutzerbestätigung** ([DL-027](./decisions/dl-027.md)); nominale **Gebindegröße** und **aktueller Inhalt** bleiben getrennt — verfügbare Menge nur über Bewegungen ([DL-028](./decisions/dl-028.md)); initiale Bestandsanlage und Bestandskorrektur sind getrennt — `inventory_correction` ist kein Anlagegrund ([DL-029](./decisions/dl-029.md)). Technischer Inventory-Core-Persistenzstand (Phase 7A, atomare Movement-Buchung, ohne Nutzerworkflow): [GA-014 §15](./architecture/ga-014.md#15-phase-7a--inventory-core-persistenz-dünger).
