...
| **Priorität** | Hoch |
| **Erstellt** | 2026-07-29 |
| **Zuletzt geändert** | 2026-08-01 (Phase 7A Inventory Core Persistenz) |
| **Verantwortlich** | — |
...
| **7b** | Nutzerworkflow Bestandsanlage — atomar Item + initiales Movement, Gebindeauflösung | 📋 offen |
...
| **Bewusst Phase 7B** | Atomare gemeinsame Anlage Item + initiales Movement; Nutzerworkflow; Gebindeauflösung; UI |
...
### 15.10 Abgrenzung Phase 7B

Noch **nicht** implementiert:

- atomare gemeinsame Anlage von Inventory Item **und** initialem positivem Movement in **einer** DB-Operation
- Nutzerworkflow „Zum Bestand hinzufügen“
- Gebindeauflösung und Nutzerbestätigung ([DL-027](../decisions/dl-027.md))
- Erzeugung mehrerer Items aus bestätigter Gebindeanzahl
- UI, öffentliche Bestandsanlage-API

Phase 7B benötigt eine **eigene** atomare PostgreSQL-Operation mit vollständigem Rollback bei Teilfehlern und Idempotenz des gesamten Anlagevorgangs. Als initialer Zugangsgrund sind nur `initial_stock`, `purchase` und `gift_received` zulässig; `inventory_correction` ist ausgeschlossen ([DL-029](../decisions/dl-029.md)).
