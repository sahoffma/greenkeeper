...
| **Priorität** | Hoch |
| **Erstellt** | 2026-07-29 |
| **Zuletzt geändert** | 2026-07-29 (Enrichment–Readiness-Schnittstelle Dünger) |
| **Verantwortlich** | — |
...
| **2** | DL-014-Normalizer + Provenienz- und Konfliktmodell + Unit-Tests | 📋 spezifiziert — [§11.5](#115-dl-014-normalisierung), [§11.8](#118-konfliktmodell) |
...
| **2** | DL-014-Normalizer + Konflikt-/Provenienztypen + Tests | 0-%-Regel isoliert testbar vor Persistenz |
