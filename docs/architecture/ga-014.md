...
Phase 7B benötigt eine **eigene** atomare PostgreSQL-Operation mit vollständigem Rollback bei Teilfehlern und Idempotenz des gesamten Anlagevorgangs.
