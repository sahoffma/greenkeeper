...
| **Priorität** | Hoch |
| **Erstellt** | 2026-07-29 |
| **Zuletzt geändert** | 2026-07-29 (Phase 3: kontrollierte `failureReason` bei `failed`) |
| **Verantwortlich** | — |
...
| **3** | Enrichment-Orchestrierung + Quellenadapter + Timeout — noch kein Save | 📋 spezifiziert — [§13](#13-phase-3-enrichment-orchestrierung-quellenadapter-und-timeout-dünger) |
...
| Job-Persistenz (DB vs. ephemeral) | offen |
| Idempotency-Key-Format | offen |
| Fortschrittsanzeige (Granularität) | offen — Phase 4/UI |
| Datenschutz-Retention Rohquellen | offen |
...
Keine offene Entscheidung wird durch unbelegte Annahmen geschlossen.
