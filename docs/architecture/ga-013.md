...
| **UI-Darstellung** | NPK, Quelle und Verifizierungsstatus werden intern getrennt formatiert; der **Recognition-Ergebnisbildschirm** zeigt keine technischen Verifizierungsstatus — Quellen- und Qualitätsinformationen bleiben intern erhalten und werden nur dort angezeigt, wo sie für die Nutzerentscheidung relevant sind (z. B. Produktdetail) |
